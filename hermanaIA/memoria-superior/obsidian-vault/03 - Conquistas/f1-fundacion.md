...
fuente: progreso.md
peso: 5
tags: [comando, vectorial, progreso]
---

# F1 - Fundación

F1 - Fundación
- Directorio `memoria-superior/` con 15 subdirectorios
- Venv aislado (Python 3.12, lancedb 0.34, sentence-transformers 5.6, torch CPU-only)
- Modelo all-MiniLM-L6-v2 cacheado (384d, ~90MB)
- Makefile: 6 nuevos targets
...
## Enlaces relacionados
  ...
  - [[03 - Conquistas/2-refactor-de-opencodejson-adn-molecular]]
