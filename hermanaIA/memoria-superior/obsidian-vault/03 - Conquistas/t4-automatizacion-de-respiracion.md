...
fuente: progreso.md
peso: 5
tags: [respiracion, comando, progreso]
---

# T4: Automatización de respiración

T4: Automatización de respiración
- Script conquistas/automatizacion-respiracion.sh
- make breathe + make continue -- protocolo post-etapa sin fricción
